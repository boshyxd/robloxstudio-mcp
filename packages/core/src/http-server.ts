...
const TOOL_HANDLERS: Record<string, ToolHandler> = {
  ...
  get_project_map: (tools, body) => tools.getProjectMap(body),
  find_instances: (tools, body) => tools.findInstances(body),
  find_scripts: (tools, body) => tools.findScripts(body),
  find_references: (tools, body) => tools.findReferences(body),
  get_instance_summary: (tools, body) => tools.getInstanceSummary(body),
  ...
  read_script_slice: (tools, body) => tools.readScriptSlice(body.instancePath, {
    startLine: body.startLine,
    endLine: body.endLine,
    aroundPattern: body.aroundPattern,
    contextLines: body.contextLines,
