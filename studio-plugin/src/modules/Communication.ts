...
const routeMap: Record<string, Handler> = {
	...
	"/api/project-map": QueryHandlers.getProjectMap,
	"/api/find-instances": QueryHandlers.findInstances,
	"/api/find-scripts": QueryHandlers.findScripts,
	"/api/find-references": QueryHandlers.findReferences,
	"/api/instance-summary": QueryHandlers.getInstanceSummary,
	...
	"/api/get-script-outline": ScriptHandlers.getScriptOutline,
	"/api/read-script-slice": ScriptHandlers.readScriptSlice,
